    ...
    return (
        <section>
            <div className='max-w-[1400px] mx-auto px-[3rem] py-[5rem]'>
                ...
                <div className='py-6 flex justify-end gap-x-3'>
                    <button className='custom-prev bg-zinc-100 p-4 text-zinc-800 text-2xl rounded-lg flex justify-center items-center  hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer'><IoIosArrowBack /></button>
                    <button className='custom-next bg-zinc-100 p-4  text-zinc-800 text-2xl rounded-lg flex justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer'><IoIosArrowForward /></button>
                                ...
                                <SwiperSlide className='bg-zinc-100 rounded-xl p-8'>
                                    <div className='flex gap-10 items-center'>
                                        ...
                                        <div>
                                            ...
                                            <span className='flex text-xl text-yellow-400 mt-6 gap-1'>{Array.from({ length: item.rating }, (_, index) => (
                                                <FaStar />
                                            ))}</span>
